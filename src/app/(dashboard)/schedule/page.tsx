    ...
    <div className="space-y-6">
      <div className="card card-padding flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="page-subtitle">Jadwal pelajaran, agenda ujian, dan kalender akademik sekolah.</p>
        </div>
        <Link href="/academic" className="btn-outline inline-flex items-center gap-2 self-start lg:self-auto">
      ...
      <div className="grid gap-4 xl:grid-cols-3">
        {DAYS.map((day) => (
          <div key={day.day} className="card card-padding space-y-4">
      ...
      <div className="card card-padding">
        <h2 className="text-base font-semibold text-gray-900">Kalender akademik siap backend</h2>
        <p className="mt-2 text-sm leading-6 text-gray-500">
          Halaman ini bisa dipakai untuk jadwal pelajaran, deadline tugas, agenda sekolah, dan event ujian. Backend nanti tinggal isi data dari kalender akademik atau tabel schedule.
        </p>
      </div>
    </div>
  );
