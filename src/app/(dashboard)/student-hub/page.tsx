...
const QUICK_ACTIONS = [
  ...
  { title: "Leaderboard", desc: "Pantau ranking dan achievement siswa.", href: "/reports", icon: Medal, tone: "amber" },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        {[
          { label: "Progress Belajar", value: "72%", detail: "+8% dari minggu lalu", color: "blue" },
          { label: "Tugas Aktif", value: "5", detail: "2 mendekati deadline", color: "green" },
          { label: "Peringkat Kelas", value: "#4", detail: "Naik 2 peringkat", color: "amber" },
          { label: "Streak Belajar", value: "11 hari", detail: "Mode konsisten aktif", color: "purple" },
        ].map((item) => (
