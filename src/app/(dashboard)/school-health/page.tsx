  ...
  return (
    <div className="space-y-6">
      <div className="card card-padding flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        <div>
          <h1 className="page-title">School Health Analytics</h1>
          <p className="page-subtitle">Analitik stabilitas internet, success rate ujian, sync time, dan benchmark sekolah.</p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <div className="card card-padding space-y-4">
          ...
          <div className="rounded-2xl border border-[#d8e6fb] bg-[#f7fbff] p-4 text-sm text-[#2f66e9]">
            Cocok untuk laporan agregat dan benchmarking multi sekolah.
          </div>
        </div>
      </div>
    </div>
