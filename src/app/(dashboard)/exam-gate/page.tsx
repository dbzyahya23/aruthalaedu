...
import { ShieldAlert, ArrowLeft, MonitorX, LockKeyhole } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="card card-padding flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <Link href="/ujian" className="btn-outline inline-flex items-center gap-2 self-start lg:self-auto">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="card card-padding space-y-4">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#eef5ff] text-[#2f66e9]">
          ...
          <div className="rounded-2xl border border-[#d8e6fb] bg-[#f7fbff] p-4 text-sm text-[#2f66e9]">
            Mode ini hanya anchor frontend untuk flow ujian aman. Logic sebenarnya ditangani backend / middleware.
          </div>
        </div>
      </div>
