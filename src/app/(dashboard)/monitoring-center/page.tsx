      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="card card-padding lg:col-span-2 space-y-4">
          <div className="flex items-center gap-2">
            <Activity className="h-5 w-5 text-[#2f66e9]" />
            <h2 className="text-base font-semibold text-gray-900">Signal panel</h2>
          </div>
        ...
        <div className="card card-padding space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-gray-900">Alert channel</h2>
          </div>
          ...
          <div className="rounded-2xl border border-[#d8e6fb] bg-[#f7fbff] p-4 text-sm text-[#2f66e9]">
            ...
            Gunakan route ini sebagai basis health dashboard internal.
          </div>
        </div>
      </div>
    </div>
